...
Every interval is checked for overlap and DDR bounds.

```text
P7D_MEMORY_BUDGET_GO TARGET_BYTES=4024909824 RUNTIME_RESERVED=5533696 LOW_TAIL=225243136 OVERLAPS=0
```
...
- memory report: 1,159 bytes, SHA256
  `32647df603cf8d71d608f15c686d8ddd9018a2028d5c6d3c862aab7fa2ffaeed`.
