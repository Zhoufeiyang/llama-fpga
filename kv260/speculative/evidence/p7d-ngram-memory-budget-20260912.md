...
It conservatively reserves 6,045,760 bytes after the low target region for the
4096-entry n-gram table, the 512,064-byte INT8 tiny draft, K=4 FP16 activation storage, simultaneous Gate/Up
...
7,675,840 bytes remain between the low allocations and the A53 window;
38,010,880 bytes remain after the high target image.

```text
P7D_MEMORY_BUDGET_GO TARGET_BYTES=4024909824 RUNTIME_RESERVED=6045760 LOW_TAIL=7675840 OVERLAPS=0
```
...
- linker-aware memory report: 1,338 bytes, SHA256
  `9d53da4a6c166155890ed564e29293eaefe7d6709dbc6ceebe3464ac5ff2a5d1`.
