...
$generated=Join-Path (Split-Path $PSScriptRoot -Parent) 'build\p6b_axilite_elab\AxiLiteCtrl.v'
if(-not(Test-Path -LiteralPath $generated)){throw 'Missing generated AxiLiteCtrl.v; elaborate top.AxiLiteCtrlP5Test and copy it to p6b_axilite_elab'}
